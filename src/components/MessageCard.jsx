...
function MessageCard({ isActive }) {
  ...
  const message = `Dear Mili,

Happy Birthday! 🎂✨

On this special day, I just want you to know how grateful I am 
to have you in my life my meetha dil 😌

Nthg much to say, but my personal favourite human, full chatpati & mastikhor 😋
and the only girl who can make my mood theek in 0.2 secs just by saying 
"Suno na babu 🥺" 
